...
const (
	...
	LogRecipeVersionCreated = "brew recipe version created: recipe_id=%d version=%d"
	LogRecipeCurrentSet     = "brew recipe current version set: recipe_id=%d version=%d"
	LogRecipeVersionStatus  = "brew recipe version status updated: recipe_id=%d version=%d status=%s"
